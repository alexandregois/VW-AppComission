//
//  PerformedFrotaViewController.swift
//  App Commission
//
...
class PerformedFrotaViewController: UIViewController {
    ...
    override func viewDidLoad() {
        self.screenTitle.text = "Performado - Frota"
        super.viewDidLoad()
    ...
    @objc func goToFullTable() {
        let frotaVC = PerformedFrotaFullTableViewController()
        frotaVC.performedIndex = self.performedIndex
    ...
    func selectFrota() {
        ...
        PerformedService.shared.getFrota { performedIndex, error in
