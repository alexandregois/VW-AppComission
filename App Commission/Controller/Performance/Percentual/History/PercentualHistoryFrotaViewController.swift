//
//  PercentualHistoryFrotaViewController.swift
//  App Commission
//
...
class PercentualHistoryFrotaViewController: UIViewController, ChartViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        configFooter()
        let fullTableAttributedString = NSMutableAttributedString.init(string: "Visualizar gráfico completo")
        ...
        fullGraphs.attributedText = fullTableAttributedString
...
extension PercentualHistoryFrotaViewController: AxisValueFormatter {
