//
//  PenetrationVarejoHelpViewController.swift
//  App Commission
//
...
class PenetratrionVarejoHelpViewController: UIViewController {
    ...
    public init() {
        super.init(nibName: "PenetratrionVarejoHelpViewController", bundle: nil)
    }
