...
class TermoUsoViewController: UIViewController {
...
//        self.createNavBar()
    ...
    func setupUI() {
        ...
        // WebView
                ...
                if let url = URL(string: "https://www.vwfs.com.br/termos-de-uso-e-politica-de-privacidade.html") {
