//
//  PerformanceFrotaCustomTable.swift
//  App Commission
//
//  Created by Camilo Oscar Girardelli Baptista on 14/08/23.
//

import Foundation
import UIKit

class PerformanceFrotaCustomTable: UIViewController, UIScrollViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.getPeriods()
        self.getPerformanceCustom(isFrota: self.isFrota, tipoPerformance: self.tipoPerformance, isAcumulado: self.isAcumulado, actualPeriod: nil)
    ...
    func montaTituloLink()
    {
        if let tipoPerformanceText = tipoPerformance.text {
            ...
            if tipoPerformanceText == "Financiamento de Veículos Usados" {
                ...
                linkFrota.isHidden = false
                self.tituloTabela.text = "\(tipoPerformanceText) - Frota"
            }
...
extension PerformanceFrotaCustomTable: UITableViewDelegate, UITableViewDataSource, UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        ...
        case 1:
            ...
            if isAcumuladoSelected {
                ...
                self.getPerformanceCustom(isFrota: self.isFrota, tipoPerformance: self.tipoPerformance, isAcumulado: isAcumuladoSelected, actualPeriod: periodo)
            } else {
                self.getPerformanceCustom(isFrota: self.isFrota, tipoPerformance: self.tipoPerformance, isAcumulado: isAcumuladoSelected, actualPeriod: selectedPeriod)
            }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // Se for a última seção
            ...
            cell.textoDireito.text = volumePenetration?.nrGrupo.map { String(Int($0)) }
            cell.configurarCores(viewDireitaColor: UIColor(hex: 0x001E50), textoDireitoColor: .white)
        }
        else {
            ...
            if tipoPerformance.text == "Penetration" {
                cell.textoDireito.text = String(format: "%.2f", volumePenetrationCdDn.valueCdDn ?? 0.0)
            } else {
